# This Makefile is for the Crypt::Vigenere extension to perl.
#
...
#	ABSTRACT_FROM => q[Vigenere.pm]
#	AUTHOR => q[Alistair Mills <cpan@alizta.com>]
#	NAME => q[Crypt::Vigenere]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[Vigenere.pm]
...
AR_STATIC_ARGS = cr
NAME = Crypt::Vigenere
DISTNAME = Crypt-Vigenere
NAME_SYM = Crypt_Vigenere
VERSION = undef
VERSION_SYM = undef
XS_VERSION = undef
INST_BIN = blib/bin
...
FULLEXT = Crypt/Vigenere
BASEEXT = Vigenere
PARENT_NAME = Crypt
DLBASE = $(BASEEXT)
VERSION_FROM = Vigenere.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = Vigenere.pm \
	vigenere.pl

PM_TO_BLIB = Vigenere.pm \
	$(INST_LIBDIR)/Vigenere.pm \
	vigenere.pl \
	$(INST_LIBDIR)/vigenere.pl
...
manifypods : pure_all Vigenere.pm
	@$(POD2MAN) \
	Vigenere.pm \
	$(INST_MAN3DIR)/Crypt::Vigenere.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/Vigenere.pm $(INST_LIBDIR)/vigenere.pl
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Crypt-Vigenere\" VERSION=\"undef,0,0,0\">\n}. qq{\t<TITLE>Crypt-Vigenere</TITLE>\n}. qq{\t<ABSTRACT>Perl implementation of the Vigenere cipher</ABSTRACT>\n}. qq{\t<AUTHOR>Alistair Mills &lt;cpan\@alizta.com&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-freebsd\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Crypt-Vigenere.ppd
